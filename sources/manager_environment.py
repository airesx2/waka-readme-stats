...
class EnvironmentManager:
    ...
    SHOW_PROJECTS = getenv("INPUT_SHOW_PROJECTS", "False").lower() in _TRUTHY
    SHOW_EDITORS = getenv("INPUT_SHOW_EDITORS", "False").lower() in _TRUTHY
    SHOW_TIMEZONE = getenv("INPUT_SHOW_TIMEZONE", "True").lower() in _TRUTHY
    SHOW_COMMIT = getenv("INPUT_SHOW_COMMIT", "False").lower() in _TRUTHY
    ...
    SHOW_DAYS_OF_WEEK = getenv("INPUT_SHOW_DAYS_OF_WEEK", "False").lower() in _TRUTHY
    ...
    if MAX_REPOS < 0:
        MAX_REPOS = 0
    SYMBOL_VERSION = int(getenv("INPUT_SYMBOL_VERSION", "3"))
